...
vi.mock("@/features/dispatchOrders/useNegotiatedCost", () => ({ useNegotiatedCost: () => ({ data: 32.75 }) }));
...
const variant = { id: "v1", sku: "AIR", attributes: { color: "Negro" }, costPriceUSD: "18", wholesalePrice: "55.68", retailPrice: "72.38", wholesaleDiscountPct: "5", retailDiscountPct: "10" } as unknown as Variant;
